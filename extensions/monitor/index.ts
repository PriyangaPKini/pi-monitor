...
function inferPiSessionStatus(summary: PiSessionSummary): MonitorStatus {
	...
	if (/awaiting user|waiting for user|waiting on user|seeking input|needs input|need your input|let me know|please confirm|confirm\b|permission required|needs attention/.test(text)) {
		return "blocked";
	}
